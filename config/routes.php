...
$app->route('/claim/{id:\d+}/poa/sirius[/{poaId:\d+}]', App\Action\Poa\PoaSiriusAction::class, ['GET', 'POST'], 'claim.poa.sirius');
...
$app->route('/claim/{id:\d+}/poa/meris[/{poaId:\d+}]', App\Action\Poa\PoaMerisAction::class, ['GET', 'POST'], 'claim.poa.meris');
